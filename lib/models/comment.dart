// Modelo de Comentario (de Jhogan)
class Comment {
  final String id;
  final String text;
  final String userId;
  ...
  final String?
      userReaction; // Reacción del usuario actual: 'like', 'dislike', null
  ...
  factory Comment.fromJson(Map<String, dynamic> json) {
    return Comment(
      ...
      imageUrls: (() {
        ...
        final dynamic v =
            json['imageUrls'] ?? json['imagenes'] ?? json['downloadUrls'];
        if (v is List) {
  ...
  bool isDislikedBy(String userId) =>
      dislikes.isNotEmpty && dislikes.contains(userId);
}
